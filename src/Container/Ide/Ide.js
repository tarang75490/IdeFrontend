...
import modeAndLanguageCode from '../data.js'
...
class Ide extends React.Component {
  ...
  onSubmit=()=>{
    ...
    axios.post('https://tarang-online-ide.herokuapp.com/submitCode',{
      ...
      input:this.state.input
        ...
        if(response.data){
          setTimeout(()=>{
            axios.get('https://tarang-online-ide.herokuapp.com/getResult/'+response.data.response.token).then((response)=>{
              console.log(response)
              this.setState({
                loading:false,
